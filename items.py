...
#armour    I added armour in but idk if there's an armour type 
    "helmet":item("helmet","helmet",9,"A garment for protecting the head, helps stop concussions.",60,"armour",30),
    "chestplate":item("chestplate","chestplate",20,"A garment for protecting the chest, will provide safety against weapons.",70,"armour",40),
    "leggings":item("leggings","leggings",8,"A garment for protecting the legs, could be useful.",50,"armour",25),
    "boots":item("boots","boots",5,"A garment for protecting the feet, keeps your toes warm.",40,"armour",25),
#potions
